        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShelterAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_UserCategory_UserCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AnimalName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    AnimalGender = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    AnimalStatus = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    AnimalHistory = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Animal_Customers_AdopterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Breed_AnimalCategoryId",
                table: "Breed",
                column: "AnimalCategoryId");
